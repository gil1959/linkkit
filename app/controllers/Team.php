...
class Team extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['user_id'], ['user_email'], ['team_member_id', 'last_datetime', 'user_email', 'datetime'], allowed_datetime_fields: ['last_datetime', 'datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('team/' . $team->team_id . '?' . $filters->get_get() . '&page={{PAGE}}')));
