    ...
    public function index() {
        ...
        switch($type) {
            ...
            case 'entries':
                ...
                /* Prepare the filtering system */
                $filters = (new \Altum\Filters(['project_id'], [], ['datetime'], allowed_datetime_fields: ['datetime']));
                ...
                $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('links-statistics?' . $filters->get_get() . 'type=' . $type . '&start_date=' . $datetime['start_date'] . '&end_date=' . $datetime['end_date'] . $filters->get_get() . '&page={{PAGE}}')));
