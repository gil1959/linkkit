...
class AccountPayments extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['processor', 'type', 'frequency', 'status'], [], ['id', 'total_amount', 'datetime'], allowed_datetime_fields: ['datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('account-payments?' . $filters->get_get() . '&page={{PAGE}}')));
