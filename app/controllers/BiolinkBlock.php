            ...
            throw_404();
                ...
                switch($type) {
                    ...
                    case 'entries':
                        ...
                        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('biolink-block/' . $this->biolink_block->biolink_block_id . '/statistics?type=' . $type . '&start_date=' . $datetime['start_date'] . '&end_date=' . $datetime['end_date'] . $filters->get_get() . '&page={{PAGE}}')));
