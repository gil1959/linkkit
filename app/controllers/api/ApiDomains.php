...
class ApiDomains extends Controller {
    ...
    private function get_all() {
        ...
        $filters = (new \Altum\Filters(['user_id', 'is_enabled'], ['host'], ['domain_id', 'last_datetime', 'host', 'datetime'], allowed_datetime_fields: ['last_datetime', 'datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('api/domains?' . $filters->get_get() . '&page={{PAGE}}')));
