...
class ApiPixels extends Controller {
    ...
    private function get_all() {
        ...
        $filters = (new \Altum\Filters(['type'], ['name', 'pixel'], ['pixel_id', 'last_datetime', 'name', 'datetime'], allowed_datetime_fields: ['last_datetime', 'datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('api/pixels?' . $filters->get_get() . '&page={{PAGE}}')));
