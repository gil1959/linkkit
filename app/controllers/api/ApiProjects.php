...
class ApiProjects extends Controller {
    ...
    private function get_all() {
        ...
        $filters = (new \Altum\Filters([], ['name'], ['project_id', 'last_datetime', 'name', 'datetime'], allowed_datetime_fields: ['datetime', 'last_datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('api/projects?' . $filters->get_get() . '&page={{PAGE}}')));
