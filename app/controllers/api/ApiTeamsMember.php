...
class ApiTeamsMember extends Controller {
    ...
    private function get_all() {
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('api/teams-member?' . $filters->get_get() . '&page={{PAGE}}')));
    ...
    private function patch() {
        ...
        $team_member->user_id = $this->user->user_id;
        $team_member->status = $_POST['status'];
        $team_member->last_datetime = $last_datetime;
