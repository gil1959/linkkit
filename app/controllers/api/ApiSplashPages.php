...
class ApiSplashPages extends Controller {
    ...
    private function get_all() {
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('api/splash-pages?' . $filters->get_get() . '&page={{PAGE}}')));
    ...
    private function post() {
        ...
        /* Prepare the data */
        $data = [
            'id' => (int) $splash_page_id,
            'user_id' => (int) $this->user->user_id,
            'name' => $_POST['name'],
            'title' => $_POST['title'],
            'description' => $_POST['description'],
            'link_unlock_seconds' => $_POST['link_unlock_seconds'],
            'auto_redirect' => (bool) $_POST['auto_redirect'],
