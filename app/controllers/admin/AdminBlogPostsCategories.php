...
class AdminBlogPostsCategories extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters([], ['title', 'url'], ['blog_posts_category_id', 'datetime', 'last_datetime'], allowed_datetime_fields: ['datetime', 'last_datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/blog-posts-categories?' . $filters->get_get() . '&page={{PAGE}}')));
