...
class AdminPageUpdate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['type'] = in_array($_POST['type'], ['internal', 'external', 'feature']) ? input_clean($_POST['type']) : 'internal';
            ...
            $_POST['footer_category_id'] = isset($_POST['footer_category_id']) ? $_POST['footer_category_id'] : null;
