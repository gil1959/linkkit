...
class AdminBroadcasts extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['status', 'segment'], ['name', 'content'], ['broadcast_id', 'name', 'datetime', 'last_datetime', 'total_emails', 'sent_emails', 'views', 'clicks', 'last_sent_email_datetime'], allowed_datetime_fields: ['datetime', 'last_datetime', 'last_sent_email_datetime']));
