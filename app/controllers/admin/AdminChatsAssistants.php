...
class AdminChatsAssistants extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters([], ['name'], ['chat_assistant_id', 'datetime', 'name', 'total_usage'], allowed_datetime_fields: ['datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/chats-assistants?' . $filters->get_get() . '&page={{PAGE}}')));
