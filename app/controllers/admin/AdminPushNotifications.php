...
class AdminPushNotifications extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['status'], ['title', 'description'], ['push_notification_id', 'title', 'datetime', 'last_datetime', 'total_push_notifications', 'sent_push_notifications', 'last_sent_datetime'], allowed_datetime_fields: ['datetime', 'last_datetime', 'last_sent_datetime']));
