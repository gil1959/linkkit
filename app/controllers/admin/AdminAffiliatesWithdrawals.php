...
class AdminAffiliatesWithdrawals extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['is_paid', 'user_id'], [], ['affiliate_withdrawal_id', 'amount', 'datetime'], allowed_datetime_fields: ['datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/affiliates-withdrawals?' . $filters->get_get() . '&page={{PAGE}}')));
