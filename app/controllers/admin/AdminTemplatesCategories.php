...
class AdminTemplatesCategories extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters([], ['name'], ['template_category_id', 'datetime', 'name'], allowed_datetime_fields: ['datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/templates-categories?' . $filters->get_get() . '&page={{PAGE}}')));
