...
class AdminTemplates extends Controller {
    ...
    public function index() {
        ...
        $filters = (new \Altum\Filters(['template_category_id'], ['name'], ['template_id', 'datetime', 'name', 'total_usage'], allowed_datetime_fields: ['datetime']));
        ...
        $paginator = (new \Altum\Paginator($total_rows, $filters->get_results_per_page(), $_GET['page'] ?? 1, url('admin/templates?' . $filters->get_get() . '&page={{PAGE}}')));
