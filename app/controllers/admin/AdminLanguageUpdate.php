                ...
                switch($type) {
                    ...
                    default:
                        ...
                        if($_POST['language_name'] != $language['name']) {
                            db()->where('language', $language['name'])->update('pages_categories', [
                                'language' => $_POST['language_name'],
                            ]);

                            db()->where('language', $language['name'])->update('pages', [
                                'language' => $_POST['language_name'],
                            ]);

                            db()->where('language', $language['name'])->update('blog_posts_categories', [
                                'language' => $_POST['language_name'],
                            ]);

                            db()->where('language', $language['name'])->update('blog_posts', [
                                'language' => $_POST['language_name'],
                            ]);

                            db()->where('language', $language['name'])->update('users', [
                                'language' => $_POST['language_name'],
                            ]);
