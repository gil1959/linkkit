...
class Link extends Model {
    ...
    public function delete($link_id) {
        ...
        if(!$link = db()->where('link_id', $link_id)->getOne('links', ['user_id', 'link_id', 'biolink_theme_id', 'type', 'settings', 'additional'])) {
            return;
        }
        ...
        if($link->type == 'static') {
            ...
            remove_directory_and_contents(\Altum\Uploads::get_full_path('static') . ($link->settings->static_folder ?: $link->additional->static_folder));
        }
