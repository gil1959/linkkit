...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">\YooKassa\Model\AmountInterface OR array</code> | value  | Сумма, которая спишется с электронного сертификата |
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">string</code> | basket_id  | Идентификатор корзины покупки |
