        ...
        "itemListElement": [
            {
                ...
                },
                {
                    "@type": "ListItem",
                    "position": 2,
                    "name": <?= json_encode(l('tools.title')) ?>,
                    "item": <?= json_encode(url('tools')) ?>
                },
                {
                    "@type": "ListItem",
                    "position": 3,
                    "name": <?= json_encode(l('tools.' . \Altum\Router::$method . '.name')) ?>,
                    "item": <?= json_encode(url(\Altum\Router::$original_request)) ?>
                }
            ]
        }
</script>
