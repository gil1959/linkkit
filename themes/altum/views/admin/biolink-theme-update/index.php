...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        ...
        <form id="biolink_theme_update" action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#biolink_container" aria-expanded="false" aria-controls="biolink_container">
            ...
            <div class="collapse" data-parent="#biolink_theme_update" id="biolink_container">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="biolink_font_size" type="number" min="12" max="22" name="biolink_font_size" class="form-control" value="<?= $data->biolink_theme->settings->biolink->font_size ?>" />
            ...
            <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#biolink_block_container" aria-expanded="false" aria-controls="biolink_block_container">
            ...
            <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#biolink_block_socials_container" aria-expanded="false" aria-controls="biolink_block_socials_container">
            ...
            <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#biolink_block_paragraph_container" aria-expanded="false" aria-controls="biolink_block_paragraph_container">
            ...
            <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#biolink_block_heading_container" aria-expanded="false" aria-controls="biolink_block_heading_container">
