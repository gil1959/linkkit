...
<div id="links">
    ...
    <button class="btn btn-block btn-gray-200 font-size-little-small font-weight-450 mb-4" type="button" data-toggle="collapse" data-target="#statics_container" aria-expanded="false" aria-controls="statics_container">
        <i class="fas fa-fw fa-file-code fa-sm mr-1"></i> <?= l('admin_settings.links.statics') ?>
    </button>

    <div class="collapse" data-parent="#links" id="statics_container">
        <div class="form-group custom-control custom-switch">
        ...
        <div class="form-group custom-control custom-switch">
            <input id="static_ai_is_enabled" name="static_ai_is_enabled" type="checkbox" class="custom-control-input" <?= settings()->links->static_ai_is_enabled ? 'checked="checked"' : null?>>
            <label class="custom-control-label" for="static_ai_is_enabled"><?= l('admin_settings.links.static_ai_is_enabled') ?></label>
            <small class="form-text text-muted"><?= l('admin_settings.links.static_ai_is_enabled_help') ?></small>
        </div>

        <div class="form-group">
            <label for="openai_api_url"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('admin_settings.links.openai_api_url') ?></label>
            <input id="openai_api_url" type="text" name="openai_api_url" class="form-control" value="<?= settings()->links->openai_api_url ?>" />
            <small class="form-text text-muted"><?= l('admin_settings.links.openai_api_url_help') ?></small>
        </div>

        <div class="form-group">
            <label for="openai_api_key"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_settings.links.openai_api_key') ?></label>
            <input id="openai_api_key" type="text" name="openai_api_key" class="form-control" value="<?= settings()->links->openai_api_key ?>" />
        </div>

        <div class="form-group">
            <label for="openai_model"><i class="fas fa-fw fa-sm fa-robot text-muted mr-1"></i> <?= l('admin_settings.links.openai_model') ?></label>
            <input id="openai_model" type="text" name="openai_model" class="form-control" value="<?= settings()->links->openai_model ?>" />
            <small class="form-text text-muted"><?= sprintf(l('admin_settings.links.openai_model_help'), '<code data-copy>' . implode('</code>, <code data-copy>', ['gpt-5.2','gpt-5.1','gpt-5','gpt-5-mini','gpt-5-nano','gpt-4.1','gpt-4.1-mini']) . '</code>') ?></small>
        </div>
    </div>
