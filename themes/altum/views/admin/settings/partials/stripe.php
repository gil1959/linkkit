...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group custom-control custom-switch">
            <input id="automatic_tax_is_enabled" name="automatic_tax_is_enabled" type="checkbox" class="custom-control-input" <?= settings()->stripe->automatic_tax_is_enabled ? 'checked="checked"' : null?>>
            <label class="custom-control-label" for="automatic_tax_is_enabled"><?= l('admin_settings.stripe.automatic_tax_is_enabled') ?></label>
            <small class="form-text text-muted"><?= l('admin_settings.stripe.automatic_tax_is_enabled_help') ?></small>
        </div>
