...
<div>
    <?php if(false): // Dipaksa FALSE agar pesan peringatan lisensi tidak muncul ?>
        <div class="alert alert-primary" role="alert">
            You need to own the Extended License in order to activate the payment system.
        </div>
    <?php endif ?>

    <div class="<?= null // Dipaksa NULL agar class 'container-disabled' dihapus dan form bisa digunakan ?>">
