...
<div>
    ...
    <button class="btn btn-block btn-gray-100 font-size-small font-weight-450 my-4" type="button" data-toggle="collapse" data-target="#theme_container" aria-expanded="false" aria-controls="theme_container">
        <i class="fas fa-fw fa-paintbrush fa-sm mr-1"></i> <?= l('admin_settings.smtp.theme') ?>
    </button>

    <div class="collapse" id="theme_container">
        <div class="form-group">
            <label for="links_color"><?= l('admin_settings.smtp.links_color') ?></label>
            <input id="links_color" type="hidden" name="links_color" class="form-control" value="<?= settings()->smtp->links_color ?? '#1b1b1b' ?>" data-color-picker />
        </div>
