                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="datetime_field" id="filters_datetime_field" class="custom-select custom-select-sm" data-toggle-datetime-filters="#filters_datetime">
                                ...
                                <option value="datetime" <?= $data->filters->datetime_field == 'datetime' ? 'selected="selected"' : null ?>><?= l('admin_users.datetime') ?></option>
                                <option value="last_activity" <?= $data->filters->datetime_field == 'last_activity' ? 'selected="selected"' : null ?>><?= l('admin_users.last_activity') ?></option>
                            </select>
                        </div>
