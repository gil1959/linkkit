                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="datetime_field" id="filters_datetime_field" class="custom-select custom-select-sm" data-toggle-datetime-filters="#filters_datetime">
                                    ...
                                    <option value="last_sent_email_datetime" <?= $data->filters->datetime_field == 'last_sent_email_datetime' ? 'selected="selected"' : null ?>><?= sprintf(l('admin_broadcasts.last_sent_email_datetime'), '') ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="order_by" id="filters_order_by" class="custom-select custom-select-sm">
                                    ...
                                    <option value="last_sent_email_datetime" <?= $data->filters->order_by == 'last_sent_email_datetime' ? 'selected="selected"' : null ?>><?= sprintf(l('admin_broadcasts.last_sent_email_datetime'), '') ?></option>
                                    <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= l('global.name') ?></option>
