...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'broadcast_duplicate_modal', 'resource_id' => 'broadcast_id', 'path' => 'admin/broadcasts/duplicate']), 'modals', 'broadcast_duplicate_modal'); ?>
