                            ...
                            <div class="row" data-display-container>
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="<?= \Altum\Language::$main_name . '_' . $form_key ?>" class="form-control" readonly="readonly"><?= htmlspecialchars($value, ENT_QUOTES, 'UTF-8') ?></textarea>
                                    </div>
                                </div>
...
<script>
    ...
    let translate = async button => {
        ...
        const openai_api_endpoint = <?= json_encode(settings()->main->openai_api_url . 'v1/responses') ?>;
