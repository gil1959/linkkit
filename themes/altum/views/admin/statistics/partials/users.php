...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-sign-in-alt fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.users.sources') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-box-open fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.users.plans') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-laptop fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.users.devices') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-server fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.users.operating_systems') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-window-restore fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.users.browsers') ?></h2>
