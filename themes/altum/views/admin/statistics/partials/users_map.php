...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-globe-europe fa-xs text-primary-900 mr-2"></i> <?= l('global.continents') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-flag fa-xs text-primary-900 mr-2"></i> <?= l('global.countries') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-city fa-xs text-primary-900 mr-2"></i> <?= l('global.cities') ?></h2>
