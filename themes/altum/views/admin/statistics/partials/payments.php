...
<div class="card mb-5">
    <div class="card-body">
        <div class="d-flex justify-content-between mb-4">
            <h2 class="h5 text-truncate mb-0"><i class="fas fa-fw fa-credit-card fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.payments.header') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-piggy-bank fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.payments.processors') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-box-open fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.payments.plans') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-dollar-sign fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.payments.types') ?></h2>
...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h5 mb-4"><i class="fas fa-fw fa-bag-shopping fa-xs text-primary-900 mr-2"></i> <?= l('admin_statistics.payments.frequencies') ?></h2>
