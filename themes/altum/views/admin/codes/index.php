                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="datetime_field" id="filters_datetime_field" class="custom-select custom-select-sm" data-toggle-datetime-filters="#filters_datetime">
                                    ...
                                    <option value="start_datetime" <?= $data->filters->datetime_field == 'start_datetime' ? 'selected="selected"' : null ?>><?= l('admin_codes.start_datetime') ?></option>
                                    <option value="end_datetime" <?= $data->filters->datetime_field == 'end_datetime' ? 'selected="selected"' : null ?>><?= l('admin_codes.end_datetime') ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group px-4">
                                ...
                                <select name="order_by" id="filters_order_by" class="custom-select custom-select-sm">
                                    ...
                                    <option value="start_datetime" <?= $data->filters->order_by == 'start_datetime' ? 'selected="selected"' : null ?>><?= l('admin_codes.start_datetime') ?></option>
                                    <option value="end_datetime" <?= $data->filters->order_by == 'end_datetime' ? 'selected="selected"' : null ?>><?= l('admin_codes.end_datetime') ?></option>
                                    <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= l('global.name') ?></option>
                                    <option value="code" <?= $data->filters->search_by == 'code' ? 'selected="selected"' : null ?>><?= l('admin_codes.code') ?></option>
