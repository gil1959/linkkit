...
<footer class="d-flex flex-column flex-lg-row justify-content-between">
    <div class="mb-3 mb-lg-0 font-size-small text-muted">
        <div class="mb-2"><?= sprintf(l('global.footer.copyright'), date('Y'), settings()->main->title) ?></div>

        <div>Powered by <img src="<?= ASSETS_FULL_URL . 'images/altumcode.svg' ?>" class="icon-favicon" alt="AltumCode logo" /> <a href="https://altumcode.com/" class="text-gray-900 font-weight-450" target="_blank">AltumCode</a>.</div>
    </div>
