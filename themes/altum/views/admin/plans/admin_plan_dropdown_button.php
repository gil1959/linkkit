...
<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/admin/plans/plan_delete_modal.php'), 'modals', 'plan_delete_modal'); ?>

<?php \Altum\Event::add_content(fn() => include_view(THEME_PATH . 'views/partials/duplicate_modal.php', ['modal_id' => 'plan_duplicate_modal', 'resource_id' => 'plan_id', 'path' => 'admin/plans/duplicate']), 'modals', 'plan_duplicate_modal'); ?>
