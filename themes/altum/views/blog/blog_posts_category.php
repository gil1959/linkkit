...
<script type="application/ld+json">
    {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": <?= json_encode(SITE_URL . ($data->blog_posts_category->language ? \Altum\Language::$active_languages[$data->blog_posts_category->language] . '/' : null) . 'blog/category/' . $data->blog_posts_category->url) ?>
            }
        ]
    }
</script>
...
<script type="application/ld+json">
    {
        ...
        "url": <?= json_encode(SITE_URL . ($data->blog_posts_category->language ? \Altum\Language::$active_languages[$data->blog_posts_category->language] . '/' : null) . 'blog/category/' . $data->blog_posts_category->url) ?>,
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": <?= json_encode(SITE_URL . ($data->blog_posts_category->language ? \Altum\Language::$active_languages[$data->blog_posts_category->language] . '/' : null) . 'blog/category/' . $data->blog_posts_category->url) ?>
        },
        "isPartOf": {
            "@type": "Blog",
            "name": <?= json_encode(l('blog.title')) ?>,
            "url": <?= json_encode(url('blog')) ?>
        },
        "publisher": {
            "@type": "Organization",
