                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="form-group" data-type="email">
                                ...
                                <input type="text" id="email_subject" name="email_subject" class="form-control <?= \Altum\Alerts::has_field_errors('email_subject') ? 'is-invalid' : null ?>" value="<?= $data->qr_code->settings->email_subject ?? null ?>" maxlength="<?= $data->available_qr_codes['email']['subject']['max_length'] ?>" data-reload-qr-code />
