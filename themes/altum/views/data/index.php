                        ...
                        <form action="" method="get" role="form">
                            <div class="form-group px-4">
                                ...
                                <select name="type" id="type" class="custom-select custom-select-sm">
                                    ...
                                    <?php foreach(['email_collector', 'phone_collector', 'contact_collector', 'appointment_calendar'] as $value): ?>
                            ...
                            <td class="text-nowrap">
                                <div class="small">
                                    <?php foreach($row->data as $key => $value): ?>
                                        <div class="d-flex">
                                            <div class="font-weight-bold text-muted mr-2" style="min-width:110px;"><?= $key ?></div>
