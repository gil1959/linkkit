    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                    ...
                    <div class="row btn-group-toggle m-n2" data-toggle="buttons">
                        ...
                        <?php foreach(array_keys(require APP_PATH . 'includes/notification_handlers.php') as $notification_handler): ?>
                            ...
                            <div class="p-2 col-12 col-lg-4">
                                <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $data->values['type'] == $notification_handler ? 'active"' : null?>" data-toggle="tooltip" title="<?= $tooltip ?>">
                                    <input type="radio" name="type" value="<?= $notification_handler ?>" class="custom-control-input" <?= $data->values['type'] == $notification_handler ? 'checked="checked"' : null?> required="required" />
                ...
                <button type="submit" name="test" class="btn btn-sm btn-block btn-outline-primary mt-3"><?= l('notification_handlers.test') ?></button>
            </form>
...
<script>
    ...
    let email_is_confirmed = <?= json_encode(!settings()->users->email_confirmation) ?>;
