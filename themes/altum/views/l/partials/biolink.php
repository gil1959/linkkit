...
<script>
    ...
    $('.modal').on('show.bs.modal', function () {
        backdrop_filter = document.body.style.backdropFilter;
        document.body.style.backdropFilter = '';
    });

    $('.modal').on('hide.bs.modal', function () {
        document.body.style.backdropFilter = backdrop_filter;
    });
    ...
    if(document.body.offsetHeight > window.innerHeight) {
        let background_attachment = document.body.style.backgroundAttachment;
