        ...
        "itemListElement": [
            {
                ...
                },
                {
                    "@type": "ListItem",
                    "position": 3,
                    "name": <?= json_encode($data->page->title) ?>,
                    "item": <?= json_encode(SITE_URL . ($data->page->language ? \Altum\Language::$active_languages[$data->page->language] . '/' : null) . 'page/' . $data->page->url) ?>
                }
            ]
        }
</script>
