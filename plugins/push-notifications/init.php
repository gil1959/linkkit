 ...
 * Auto-loaded by Plugin::initialize() when plugin is active.
 * Class name must match what AdminPlugins expects: Altum\Plugin\Pushnotifications
 */
namespace Altum\Plugin;

defined('ALTUMCODE') || die();

if(!class_exists('Altum\\Plugin\\Pushnotifications')) {
